...
void mexFunction(
   ...
   int nrhs, const mxArray *prhs[]) { /*pBa deleted since not used.*/
   double *table, *x, *ind, xi;
   mwSize i, j, jhi, inc, n, m, numfirst, n1, n2; /*m, jhi, jhi, n, mxGetNumberofElements, mxGetNumberOfElements, n, n, n*/
   mwSignedIndex jlo;  /*takes on negative values.*/
   int p;
